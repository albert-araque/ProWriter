...
public class BookViewController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		// Evento al hacer click al bot�n eliminar
		deleteBookButton.setOnMouseClicked(new EventHandler<Event>() {
			...
			public void handle(Event event) {
				...
				alert.setHeaderText("Est�s a punto de eliminar el libro de todos los proyectos");
		...
		// Evento al hacer click al bot�n ver
	...
	/**
	 * M�todo para cargar los libros de la base de datos
	 */
